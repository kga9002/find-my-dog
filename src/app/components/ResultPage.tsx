...
export default function ResultPage() {
	...
	return (
		<div className="flex flex-col mx-auto my-auto px-2">
			...
			<div className="mt-12 md:w-[400px] w-[300px] mx-auto flex flex-col">
								...
								<SwiperSlide key={o.regIg}>
									<div className="flex flex-col justify-center items-center h-full bg-white py-4 rounded-3xl">
										<img
											...
											className="w-[150px] md:w-[200px] aspect-square object-cover"
											alt=""
										/>
